...
class Darkanakin41SymfonyTemplateExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('darkanakin41.symfony_template.config', $bundleConfig);
    }

    public function prepend(ContainerBuilder $container)
    {
        if ($container->hasExtension('twig')) {
            $container->prependExtensionConfig('twig', array('paths' => array(__DIR__.'/../Resources/views' => 'Darkanakin41SymfonyTemplate')));
        }
    }
